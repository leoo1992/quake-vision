...
const dictionary = {
  pt: {
    ...
    mapHint: 'tamanho e cor representam magnitude · clique para inspecionar',
  ...
  en: {
    ...
    mapHint: 'size and color represent magnitude · click to inspect',
  ...
  es: {
    ...
    mapHint: 'tamaño y color representan magnitud · haz clic para inspeccionar',
    seismicFeed: 'Feed sísmico',
    relevantEvents: 'Eventos relevantes',
