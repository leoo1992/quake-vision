...
const dictionary = {
  pt: {
    ...
    minimumDepth: 'Profundidade mín.',
    tsunamiFilter: 'Tsunami',
    allEvents: 'Todos',
    tsunamiOnly: 'Com tsunami',
    ...
    visibleEpicenters: 'eventos no mapa',
  ...
  en: {
    ...
    visibleEpicenters: 'events on map',
  ...
  es: {
    ...
    minimumDepth: 'Profundidad mín.',
    tsunamiFilter: 'Tsunami',
    allEvents: 'Todos',
    tsunamiOnly: 'Con tsunami',
    ...
    visibleEpicenters: 'eventos en el mapa',
